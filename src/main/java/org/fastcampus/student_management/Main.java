...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    StudentInfoDto studentInfoDto1 = new StudentInfoDto("김연아", 24, "서울시 노원구");
    studentService.saveStudent(studentInfoDto);
    studentService.saveStudent(studentInfoDto1);

    CourseInfoDto courseInfoDto = new CourseInfoDto("바이올린", 1000, "MONDAY", "홍길동", 1717299888L);
    CourseInfoDto courseInfoDto1 = new CourseInfoDto("첼로", 1200, "MONDAY", "김연아", 1717299888L);
